...
namespace SmartPlayerAPI.Persistance
{
    public class SmartPlayerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlayerInGame>().HasOne(o => o.Game).WithMany(o => o.PlayerInGames);
            modelBuilder.Entity<PlayerInGame>().HasOne(o => o.Player).WithMany(o => o.PlayerInGames);
